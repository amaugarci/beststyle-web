<template>
  <div class="absolute top-0 left-0 bottom-0 right-0 flex flex-col">
    ...
    <div v-if="symbol">
      <div class="order-price-ex">
        <div class="order-price-now">
          ...
          <p id="charts-margin" :class="{sellColor:!symbol.status,buyColor:symbol.status}">DIFF：{{ symbol.DIFF }}</p>
        </div>
        ...
        <div style="padding-left: 1rem" class="order-price-btn"> <button class="buy-bg order-upbtn"
            style="margin-bottom: .3rem">买涨</button> <button class="sell-bg order-dowbtn">买跌</button> </div>
      </div>
    </div>
    <div class="buttons-tab flex">
      ...
      <span @click="changePeriod('15M')" class="tab-link button tab-time" :class="{active:period=='15M'}" data-int="15">
        15M
      </span>
      <span @click="changePeriod('1H')" class="tab-link button tab-time" :class="{active:period=='1H'}" data-int="60">
        1H
      </span>
    ...
    <VueEcharts :option="option" class="tradingView"></VueEcharts>
  ...
  methods: {
    ...
    createSocket(){
      ...
      this.connection.onmessage = (event)=>{
        ...
        this.symbol['DIFF']=(this.symbol['price']-Number(price)).toString().slice(0,4);
