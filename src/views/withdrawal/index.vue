<template>
  <div class="absolute top-0 left-0 bottom-0 right-0 flex flex-col">
    ...
    <div class="overflow-x-hidden overflow-y-auto h-full p-3">
      <div>
        <input type="number" v-model="form.amount" class="form-control form-control-sm mb-3" placeholder="提现金额"  required="">
        ...
        <button
          class="btn btn-success btn-block btn-sm" @click="sendWithdrawal">确定</button>
      </div>
    </div>
  </div>
</template>
